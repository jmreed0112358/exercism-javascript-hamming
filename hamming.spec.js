...
describe('Hamming', function () {
  ...
  it('throws exceptions when given junk input' , function () {
    ...
    }).toThrow(new Error('hamming.compute takes two strings.'));
  });

  it('throws exceptions when given empty strings', function () {
    expect(function() {
      hamming.compute('', '');
    }).toThrow(new Error('hamming.compute takes non-zero length strings.'));
  });
